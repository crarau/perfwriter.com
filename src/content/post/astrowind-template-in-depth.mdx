...
title: PerfWriter template in depth
excerpt: While easy to get started, PerfWriter is quite complex internally.  This page provides documentation on some of the more intricate parts.
...
tags:
  ...
  - front-end
metadata:
  canonical: https://PerfWriter.vercel.app/PerfWriter-template-in-depth
---
...
<CallToAction
  callToAction={{
    text: 'Get template',
    href: 'https://github.com/onwidget/PerfWriter',
